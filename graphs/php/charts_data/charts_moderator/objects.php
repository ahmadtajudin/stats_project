...
class Objects extends ChartData
{
    ...
    public function  get_data_for_group($group_type_left_or_right)
    {
        ...
        (
                array
                    (
                    array("column"=>"b1", "value"=>"1", "column_xml_additional_reference"=>""), 
                    array("column"=>"b2", "value"=>"1", "column_xml_additional_reference"=>""),
                    array("column"=>"b3", "value"=>"1", "column_xml_additional_reference"=>""),
                    array("column"=>"b4", "value"=>"1", "column_xml_additional_reference"=>""),
                    array("column"=>"b5", "value"=>"1", "column_xml_additional_reference"=>"")
                    ), 
        "quantity");
