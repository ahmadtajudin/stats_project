...
class InFuture extends ChartData 
{
    ...
    public function  get_data_for_group($group_type_left_or_right)
    {
        ...
        (
                array
                    (
                    array("column"=>"u1", "column_xml_additional_reference"=>""),
                    array("column"=>"u2", "column_xml_additional_reference"=>""),
                    array("column"=>"u3", "column_xml_additional_reference"=>"")
                    ), 
                array("from"=>"1", "to"=>"5"),
        "quantity");
        $data_for_back .= $this->get_data_xml_total_passby_and_interviews("u1");
        $data_for_back .= "</".$group_data_reference.">";
