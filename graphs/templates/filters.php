...
function FiltersModerator()
{
    ...
    this.select_options_when_client_is_dealer = function()
    {
        ...
        //$("#areas_options__A").find("option[text='Αθήνα']").attr('selected', 'selected');
        /*$("#areas_options__A option").each(function () {
            
        console.log("=>"+$(this).html());
                if ($(this).html() == "<?php print CHART_User::$LOGGED_USER->chart_dealer->dealer_area; ?>") 
                {
        console.log("[+]=>"+$(this).html());
        ...
        //$($("#areas_options__A").find("option").get(3)).prop("selected", true);
            $('#areas_options__A option')
    .filter(function() { return $.trim( $(this).text() ) == "<?php print CHART_User::$LOGGED_USER->chart_dealer->dealer_area; ?>"; })
    .prop('selected',true);
        console.log("dealer_area:<?php print CHART_User::$LOGGED_USER->chart_dealer->dealer_area; ?>");
    }
}
